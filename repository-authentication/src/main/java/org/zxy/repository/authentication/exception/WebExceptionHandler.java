package org.zxy.repository.authentication.exception;
...
import org.zxy.repository.common.exception.ModelViewException;
...
public class WebExceptionHandler {
    ...
    public Object AccessDeniedExceptionHandler(AccessDeniedException exception) throws Exception {
        return AjaxResponse.error(new CustomException(CustomExceptionType.FORBIDDEN_ERROR,"权限不足"));
    }
